...
* I use either the RStudio mirror or the Berkeley University mirror at (https://cran.cnr.berkeley.edu).
...
.f3[.red[Note: ]The rest of the slides are based on a training imparted by DIME in the World Bank]
